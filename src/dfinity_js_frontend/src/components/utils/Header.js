...
import AddContent from "../contentManager/AddContent";
import AddArtist from "../artistManager/AddArtist";
import { Link } from "react-router-dom";

const Header = ({ saveContent, saveArtist }) => {
    ...
    <>
      {isAuthenticated ? (
        <Navbar
          ...
          expand="lg"
        >
          <Navbar.Brand className="text-dark h4">Content Manager</Navbar.Brand>
          ...
          >
            <Nav className="mr-auto d-flex gap-2 align-items-center">
              ...
              <Nav.Item>
                <AddContent save={saveContent} />
              </Nav.Item>
              <Nav.Item>
                <AddArtist save={saveArtist} />
              </Nav.Item>
            </Nav>
